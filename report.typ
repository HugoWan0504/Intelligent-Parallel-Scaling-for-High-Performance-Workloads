...
The results in @fig-pwd-speedup indicate that the workload scales well up to the available physical cores, and the dynamic tuner correctly identifies the trend.
